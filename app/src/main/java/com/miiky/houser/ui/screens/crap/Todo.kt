...
fun Todo(
    ...
    Column(
        ...
        OutlinedCard(
            ...
            Column(modifier = modifier.verticalScroll(rememberScrollState()).padding(spacing/2)) {
                Task(id = 1, task = "Adios", status = false)
                Task(id = 1, task = "y", status = false)
                Task(id = 1, task = "t", status = true)
                Task(id = 1, task = "r", status = true)
                Task(id = 1, task = "e", status = false)
                Task(id = 1, task = "w", status = true)
                Task(id = 1, task = "q", status = true)
                Task(id = 1, task = "Hola", status = false)
